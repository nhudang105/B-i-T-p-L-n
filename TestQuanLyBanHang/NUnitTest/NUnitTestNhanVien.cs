...
namespace TestQuanLyBanHang.NUnitTest
{
    ...
    public class NUnitTestNhanVien
    {
        ...
        {
            new NhanVien("","Nguyen","Teo","2390 BS","098098"), //Trường hợp không nhập mã nhân viên
            new NhanVien("E02","","Ti","230 BS","029390"), //Trường hợp không nhập họ nhân viên
            new NhanVien("E03","Nguyen","","230 BSA","090098"), //Trường hợp không nhập tên nhân viên
            new NhanVien("E04","Pham","A","","0903930"), //Trường hợp không nhập địa chỉ
            new NhanVien("E05","Ngo","Kha","39 THD",""), //Trường hợp không nhập số điện thoại
